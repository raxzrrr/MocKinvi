    ...
    <Card className="glass-card border border-gray-200 dark:border-white/10">
      ...
      <CardContent>
        <div className="space-y-4">
          {!uploadedFile && (
            <div className="border-2 border-dashed rounded-lg p-6 text-center border-gray-300 dark:border-white/20">
              ...
              <Button className="mt-4 btn-primary-glass" onClick={() => document.getElementById('resume-upload')?.click()}>
                Choose File
              </Button>
            </div>
          )}
          ...
          {analyzing && (
            <div className="flex flex-col items-center justify-center py-8">
              ...
              <h3 className="font-medium text-lg mb-2 text-foreground">Analyzing your resume</h3>
