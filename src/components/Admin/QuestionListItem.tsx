        ...
        <CardContent className="p-4">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground">Option 3</label>
                <Input
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground">Option 4</label>
                <Input
            ...
            <div className="space-y-3">
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <label htmlFor="edit_correct_1" className="text-sm text-foreground">Option 1</label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="2" id="edit_correct_2" />
                  <label htmlFor="edit_correct_2" className="text-sm text-foreground">Option 2</label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="3" id="edit_correct_3" />
                  <label htmlFor="edit_correct_3" className="text-sm text-foreground">Option 3</label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="4" id="edit_correct_4" />
                  <label htmlFor="edit_correct_4" className="text-sm text-foreground">Option 4</label>
                </div>
              </RadioGroup>
            </div>
            ...
            <div className="flex gap-2">
              <Button size="sm" onClick={handleSave} className="bg-cyrobox-primary hover:bg-cyrobox-primary-dark">
                <Save className="w-4 h-4 mr-1" />
                Save
              </Button>
              <Button size="sm" variant="outline" onClick={onCancel} className="border-border hover:border-cyrobox-primary hover:text-cyrobox-primary">
                <X className="w-4 h-4" />
                Cancel
              </Button>
            </div>
      ...
      <CardContent className="p-4">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <h4 className="font-medium mb-3 text-foreground">{question.question_text}</h4>
            ...
            {question.explanation && (
              <div className="mt-3 p-3 bg-blue-50 border border-blue-200 rounded dark:bg-blue-900/20 dark:border-blue-700">
          ...
          <div className="flex gap-2 ml-4">
            <Button size="sm" variant="outline" onClick={() => onEdit(question)} className="border-border hover:border-cyrobox-primary hover:text-cyrobox-primary">
            ...
            <Button 
              ...
              className="text-red-600 hover:text-red-800 border-red-200 hover:border-red-300 dark:text-red-400 dark:border-red-700"
            >
