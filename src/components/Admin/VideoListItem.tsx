    ...
    return (
      <div className="flex-1 space-y-1">
        <Input
          ...
          className="text-xs h-6 bg-background border-border"
        />
        <Input
        ...
        <div className="flex space-x-1 mt-1">
          <Button size="sm" onClick={() => onSave(editingVideo)} className="h-6 px-2 bg-cyrobox-primary hover:bg-cyrobox-primary-dark">
            <Save className="w-3 h-3" />
          </Button>
          <Button size="sm" variant="outline" onClick={onCancel} className="h-6 px-2 border-border hover:border-cyrobox-primary hover:text-cyrobox-primary">
            <X className="w-3 h-3" />
          </Button>
        </div>
      </div>
    ...
    <>
      <div className="flex-1 space-y-1">
        <div className="flex items-center space-x-2">
          <span className="font-medium text-sm text-foreground">{video.title}</span>
          <Badge 
      ...
      <div className="flex space-x-1">
        <Button
          ...
          className="h-6 w-6 p-0 hover:bg-muted hover:text-cyrobox-primary"
        >
