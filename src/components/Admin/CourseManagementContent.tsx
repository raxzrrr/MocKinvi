    ...
    return (
      <Card className="border-border">
        <CardContent className="p-8 text-center">
          ...
          <p className="text-muted-foreground mb-4">Create your first course to get started with content management.</p>
          <Button onClick={onShowAddCourse} className="bg-cyrobox-primary hover:bg-cyrobox-primary-dark">
