  ...
  return (
    <Card className="border-border">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
        <CardTitle className="text-foreground">Add New Question</CardTitle>
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="question_text" className="text-foreground">Question Text</Label>
            <Textarea
              id="question_text"
          ...
          <div className="space-y-2">
            <Label htmlFor="difficulty_level" className="text-foreground">Difficulty Level</Label>
            <Select value={formData.difficulty_level} onValueChange={(value: 'easy' | 'intermediate' | 'hard') => setFormData({ ...formData, difficulty_level: value })}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="option_1" className="text-foreground">Option 1</Label>
              <Input
                id="option_1"
            ...
            <div className="space-y-2">
              <Label htmlFor="option_2" className="text-foreground">Option 2</Label>
              <Input
                id="option_2"
            ...
            <div className="space-y-2">
              <Label htmlFor="option_3" className="text-foreground">Option 3</Label>
              <Input
                id="option_3"
            ...
            <div className="space-y-2">
              <Label htmlFor="option_4" className="text-foreground">Option 4</Label>
              <Input
                id="option_4"
          ...
          <div className="space-y-3">
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="correct_1" className="text-foreground">Option 1</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="2" id="correct_2" />
                <Label htmlFor="correct_2" className="text-foreground">Option 2</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="3" id="correct_3" />
                <Label htmlFor="correct_3" className="text-foreground">Option 3</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="4" id="correct_4" />
                <Label htmlFor="correct_4" className="text-foreground">Option 4</Label>
              </div>
            </RadioGroup>
          </div>
          ...
          <div className="flex gap-2 pt-4">
            <Button type="submit" disabled={isSubmitting} className="bg-cyrobox-primary hover:bg-cyrobox-primary-dark">
              {isSubmitting ? 'Adding...' : 'Add Question'}
            </Button>
            <Button type="button" variant="outline" onClick={onCancel} className="border-border hover:border-cyrobox-primary hover:text-cyrobox-primary">
              Cancel
            </Button>
          </div>
        </form>
