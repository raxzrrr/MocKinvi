  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-foreground">Interview Resources</h1>
        ...
        <Card className="border-border">
          ...
          <CardContent className="space-y-4">
            ...
            <Button 
              ...
              className="w-full md:w-auto bg-cyrobox-primary hover:bg-cyrobox-primary-dark"
            >
          ...
          <CardContent>
            {loading ? (
              <div className="text-center py-8">
                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-cyrobox-primary mx-auto"></div>
              ...
              <div className="space-y-4">
                {resources.map((resource) => (
                  <div
                    key={resource.id}
                    className="flex items-center justify-between p-4 border border-border rounded-lg transition-colors hover:bg-muted/50"
                  >
                    <div className="flex-1 min-w-0">
                      <h4 className="font-medium truncate text-foreground">{resource.title}</h4>
