    ...
    return (
      <DashboardLayout>
        <div className="flex justify-center items-center py-12">
          <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-cyrobox-primary"></div>
        </div>
      </DashboardLayout>
    );
  }
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-foreground">Certificate Management</h1>
            <p className="text-muted-foreground mt-1">
              Create and manage certification templates
            </p>
          </div>
          <Button onClick={() => setIsCreating(true)} className="bg-cyrobox-primary hover:bg-cyrobox-primary-dark">
        ...
        {isCreating && (
          <Card className="border-border">
            <CardHeader>
              <CardTitle className="text-foreground">Create New Certificate Template</CardTitle>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-4">
                <Button onClick={handleCreateCertificate} className="bg-cyrobox-primary hover:bg-cyrobox-primary-dark">
                  Create Certificate
                </Button>
                <Button variant="outline" onClick={() => setIsCreating(false)} className="border-border hover:border-cyrobox-primary hover:text-cyrobox-primary">
                  Cancel
                </Button>
              </div>
            </CardContent>
