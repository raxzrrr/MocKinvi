      ...
      <div className="space-y-6">
        ...
        <Card className="border-border">
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">Configure platform-wide settings</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSaveSettings} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="site-name" className="text-foreground">Platform Name</Label>
                <Input id="site-name" defaultValue="Interview Genius" className="bg-background border-border" />
              </div>
              
              <div className="space-y-2">
                <Label htmlFor="support-email" className="text-foreground">Support Email</Label>
                <Input id="support-email" type="email" defaultValue="support@interviewgenius.com" className="bg-background border-border" />
              </div>
              
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-medium text-foreground">Enable User Registration</p>
              ...
              <Button type="submit" className="bg-cyrobox-primary hover:bg-cyrobox-primary-dark">Save Settings</Button>
            </form>
          </CardContent>
        </Card>
      </div>
