-- =====================================================
-- CERTIFICATE SYSTEM FIX - RUN THIS IN SUPABASE SQL EDITOR
-- =====================================================

-- Step 1: Add clerk_user_id column to user_certificates table
...
-- Step 3: Update existing certificates
UPDATE public.user_certificates 
SET clerk_user_id = 'legacy-certificate'
WHERE clerk_user_id IS NULL;

-- Step 4: Create unified certificates view
...
WHERE table_name = 'user_certificates' 
AND column_name = 'clerk_user_id';

SELECT 'View created' as status, schemaname, viewname 
FROM pg_views 
WHERE viewname = 'v_unified_certificates';

-- Step 6: Test the view
SELECT COUNT(*) as total_certificates FROM v_unified_certificates; 